                        ...
                        <div class="d-flex justify-content-between flex-wrap">
                           ...
                           <div class="d-flex justify-content-between align-items-end flex-wrap">
                              ...
                              <button class="btn btn-primary mt-2 mt-xl-0 mdi mdi-account-plus mdi-18px"
                                 data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg" style="margin-bottom: 12px;">&nbsp; &nbsp;New Ledger</button>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="modal-content">
                           <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel"><span
                                            class="mdi mdi-lan mdi-18px"></span> &nbsp;New Ledger</h5>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <select id="ledger" name="ledger" class="form-control" >
...
<!-- end main content-->
    ...
    $(document).ready(function() {
        ...
        $("#ledger-list").load("include/ledger.php?list");
        var ledger = "0";
        $.ajax({
            type: "GET",
            url: "include/ledger.php?list",
            cache: false,
