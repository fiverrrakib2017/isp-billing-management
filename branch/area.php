...
<div class="main-content">
    ...
    <div class="page-content">
        ...
        <a class="btn btn-info" href="area_edit.php?id=<?php echo $rows["id"]; ?>"><i class="fas fa-edit"></i></a>
        <a class="btn btn-success" href="view_area.php?id=<?php echo $rows["id"]; ?>"><i class="fas fa-eye"></i>
        </a>
        <a id="deleteId" onclick=" return confirm('Are You Sure');" href="area_delete.php?id=<?php echo $rows["id"]; ?>"  value="" class="btn btn-danger"><i class="fas fa-trash"></i></a>
        </td></tr>
                       <?php } ?>
                                    </tbody>
                                 </table>
...
$("#areaDataTable").DataTable();
        // $("#areaList").load("include/add_area.php?list");
     ...
     function deleteData(deleteId){
        ...
        $("#DeleteConfirm").click(function(){
            //var deleteId=$("#DeleteId").html();
                    $.ajax({
                    type: "GET",
                    url: "include/add_area.php?delete",
                    data: {id:deleteId},
                    cache: false,
