                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-sample">
                                    ...
                                    <button type="button" id="update_client_button" class="btn btn-info">Update Data</button>

                                    <a href="client.php" class="btn btn-danger">Cancle</a>
                                </form>
                            </div>
                        </div>
                    </div>
  ...
  <script type="text/javascript">
        $(document).ready(function(){
            $("#update_client_button").click(function(){
                var formData=$("#update_client").serialize();
                $.ajax({
                    type:"GET",
                    data:formData,
                    url:"include/client_data.php?update",
                    cache:false,
                    success:function(){
