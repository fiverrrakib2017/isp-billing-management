...
<div class="main-content">
    ...
    <div class="page-content">
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="d-flex justify-content-between flex-wrap">
                                ...
                                <div class="d-flex justify-content-between align-items-end flex-wrap">
                                    <button type="button" class="btn btn-primary mt-2 mt-xl-0 mdi mdi-account-plus mdi-18px"
       ...
       <td style="text-align:right">
        <a class="btn btn-info" href="product_profile_edit.php?clid=<?php echo $rows['id']; ?>"><i class="fas fa-edit"></i></a>
        <a class="btn btn-success" href="product_profile.php?clid=<?php echo $rows['id']; ?>"><i class="fas fa-eye"></i>
        </a>
