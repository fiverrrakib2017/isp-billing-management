...
//     $UserId_profile=$_POST['profile_pic_id'];

//     $filename=$_FILES['photo']["name"];

//     $tempname = $_FILES["photo"]["tmp_name"]; 

//  $folder = "profileImages/".$filename;

//  move_uploaded_file($tempname, $folder);

//     $con->query("UPDATE customers SET profile_pic='$filename' WHERE id='$UserId_profile'");
// }
                                                ...
                                                <div class="col-12 bg-white p-0 px-2 pb-3 mb-3">
                                                    ...
                                                    <div class="d-flex justify-content-between border-bottom py-2 px-3">
                                                        <p><i class=" fas fa-dollar-sign"></i> Package:</p> <a href="#">
                                                            ...
                                                            <?php
                                                            $popID = $package;
                                                            $allPOP = $con->query("SELECT * FROM  radgroupcheck WHERE groupname=$popID ");
                                                            while ($row = $allPOP->fetch_array()) {
                                                                echo $packagename = $row['groupname'];
                                                            }
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row no-gutters align-items-center">
                                                            <div class="col">
                                                                ...
                                                                if ($DeviceMC = $con->query("SELECT callingstationid FROM radacct WHERE username='$username' ORDER BY radacctid DESC LIMIT 1")) {
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <p>
                                                                    <?php
                                                                    if ($lastuptime = $con->query("SELECT TIMEDIFF(acctstoptime, acctstarttime) AS time FROM radacct WHERE username='$username' ORDER BY radacctid DESC LIMIT 1")) {
                                                                        while ($upt_rows = $lastuptime->fetch_array()) {
                                                                            $lstupt = $upt_rows["time"];
                                                                        }
                                                                        echo $lstupt . " Hrs";
                                                                    }
...
radacct WHERE username='$username' AND acctstoptime IS NOT NULL")) {
                                                                        while ($r_usd_rows = $lastused->fetch_array()) {
                                                                            $lstusd = $r_usd_rows["GB_OUT"];
                                                                        }
                                                                        echo number_format($lstusd, 3) . " GB";
                                                                    }
                                                                    ?>
                                                                </p>
                                                            </div>
                                                                ...
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <div class="table-responsive">
                                                                            <table id="user_activity_data_table" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th>Auth Date</th>
                                                                                        <th>Username</th>
                                                                                ...
                                                                                <tbody>
                                                                                    <?php
                                                                                    if ($usrs_activity = $con->query("SELECT * FROM radpostauth WHERE username='$username' ")) {
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    if ($recharge_customer = $con->query("SELECT * FROM customer_rechrg WHERE customer_id='$lstid' ")) {
                                                                                        while ($r_cus_rows = $recharge_customer->fetch_array()) {
                                                                                            ...
                                                                                            $r_cus_amount = $r_cus_rows["amount"];
                                                                                            ...
                                                                                            echo '
                                                                                                    ...
                                                                                                    <td>' . $r_datetm . '</td>
                                                                                                        ...
                                                                                                        <td>' . $r_unti . '</td>
                                                                                                        <td>' . $r_cus_amount . '</td>
                                                                                                        <td><button type="button" id="recharge_undo" class="btn-sm btn btn-danger"><i class="mdi mdi-undo"></i></button></td>
                                                                                                    </tr>
                                                                                                    ';
                                                                                        }
                                                                                    }
