...
if (isset($_GET["clid"])) {
    ...
    if ($client=$con->query("SELECT *FROM clients WHERE id='$clientId'  ")) {
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="card mt-3">
                                    <div class="card-title text-center mt-1">
                                        <h5>About This Client</h5>
                                    </div>
                                    <div class="card-body">
                                       <p>Client Information means any information or documentation that the Company receives from the Client or otherwise obtains which relates to him/her, his/her Account or the provision or the use of the Services.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-8">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <a type="submit" class="btn btn-info "
                                                    href="client_edit.php?clid=<?php echo $id;?>">Edit</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
