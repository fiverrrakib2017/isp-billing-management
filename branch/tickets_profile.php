            ...
            <div class="row">
               ...
               <div class="card-body">
                   <div class="col-12 bg-white p-0 px-2 pb-3 mb-3">
                    ...
                    <div class="d-flex justify-content-between border-bottom py-2 px-3">
                        <p><i class=" fas fa-dollar-sign"></i>   Assigned To:</p> <a href="#"><?php echo $asignto; ?></a>
                    </div>
                    <div class="d-flex justify-content-between border-bottom py-2 px-3">
                    ...
                    <div class="d-flex justify-content-between border-bottom py-2 px-3">
                        <p><i class="fas fa-calendar"></i> From Date</p> <a href="#"><?php echo $startdate; ?></a>
                    </div>
                    <div class="d-flex justify-content-between border-bottom py-2 px-3">
                        <p><i class="fas fa-calendar-alt"></i> To Date</p> <a href="#"><?php echo $enddate; ?></a>
                    </div>
                </div>
               </div>
           </div>
...
<!-- end main content-->
   ...
   <script type="text/javascript">
        ...
        //         var formData=$("#form-postComment").serialize();
        //         alert(formData);
        //         $.ajax({
        //             type:"GET",
        //             data:formData,
        //             url:"include/tickets.php?postComment",
        //             cache:false,
        //             success:function(){
        //                Swal.fire(
        //               'Success!',
        ...
        //      var ticketId=$("#tickId")val();  
        //      var ticket_type=$("#ticket_type").val();
        //      var progress=$("#progress")val();  
        //      var date=$("#date")val();  
        //      var commentBox=$("#commentBox")val();  
        //      addTicketData(ticketId,ticket_type,progress,date,commentBox);
        // });
        //  function addTicketData(ticketId,ticket_type,progress,date,commentBox){
            ...
            var ticket_id=$("#ticket_id").val();
             var ticket_type=$("#ticket_type").val();
              var progress=$("#progress").val(); 
               var date=$("#date").val();  
                var commentBox=$("#commentBox").val();  
            addTicketData(ticket_id,ticket_type,progress,date,commentBox);
        });
        function addTicketData(ticket_id,ticket_type,progress,date,commentBox){
            if (ticket_type.length==0) {
               toastr.error("Ticket Type is require");
            }else if(progress.length==0){
                toastr.error("Progress is require");
            }else if(date.length==0){
                toastr.error("Date is require");
            }else if(commentBox.length==0){
                toastr.error("Comment is require");
            }else{
                var addTicketComment="0";
                $.ajax({
                    type:"POST",
                    data:{id:ticket_id,type:ticket_type,progress:progress,date:date,comment:commentBox,addTicketComment:addTicketComment},
