                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="d-flex justify-content-between flex-wrap">
                                ...
                                <div class="d-flex justify-content-between align-items-end flex-wrap">
                                    <abbr title="Complain" style="padding: 5px;">
                                        <button type="button" data-target="#ComplainModalCenter" data-toggle="modal"
                                        class="btn btn-light bg-white btn-icon mr-3 d-none d-md-block ">
                                        <i class="mdi mdi-alert-outline text-muted"></i>
                                        </button>
                                    </abbr>
                                    <abbr title="Recharge"style="padding: 5px;">
                                        <button type="button" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg"
                                        class="btn btn-light bg-white btn-icon mr-3 d-none d-md-block ">
                                        <i class="mdi mdi mdi-battery-charging-90 text-muted"></i>
                                        </button>
                                    </abbr>
                                   <abbr title="Cutomers"style="padding: 5px;">
                                    <button type="button"
                                        class="btn btn-light bg-white btn-icon mr-3 d-none d-md-block ">
                                        <i class="mdi mdi mdi-account-plus text-muted"></i>
                                    </button></abbr>
                                    <abbr title="Reconnect"style="padding: 5px;">
                                        <button type="button" class="btn btn-light bg-white btn-icon mr-3 mt-2 mt-xl-0">
                                        <i class="mdi mdi-sync text-muted"></i>
                                    </button>
                                    </abbr>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        $onlineusr = $con->query("SELECT * FROM radacct WHERE acctterminatecause=''");
                                        echo $onlineusr->num_rows;
                                        //$con->close;
                                        ?>
                                                </span>
                                                Online Pop Users
                                        ...
                                        <div class="mini-stat">
                                            ...
                                            <div class="mini-stat-info">
                                                <span class="counter text-brown">
                                                    <?php if ($dsblcstmr = $con -> query("SELECT * FROM customers WHERE status='2'")) 
        {
...
?>
    ...
    if ($pop_payment=$con->query(" SELECT SUM(`amount`) AS balance FROM `pop_transaction` WHERE pop_id=$popid AND transaction_type='0'")) {
        while ($rows=$pop_payment->fetch_array()) {
            $totalpaid=$rows["balance"];
        }
        echo $totalpaid;
    }
                            ?>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                          <?php 
                            if ($pop_payment=$con->query("SELECT SUM(`amount`) AS balance FROM `pop_transaction` WHERE pop_id=$popid AND transaction_type='1'")) {
        while ($rows=$pop_payment->fetch_array()) {
            $totalDue=$rows["balance"];
        }
        echo $totalDue;
    }
                            ?>
                       ...
                       <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <p class="card-title ">POP/Branch User</p>
                                        </div>
                                        <div class="col-md-4">
                                            <!-- <button style="float: right;">
                                                <a href="customers.php">+</a>
                                            </button> -->
                                            <a class="btn-sm btn btn-success" href="customers.php"style="float: right;">+</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="cstmr_table" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>Full Name</th>
                                            ...
                                            <tbody>
                                           <?php 
                                        if ($cstmr = $con -> query("SELECT * FROM customers WHERE pop='$popid' LIMIT 5")) {
                                          while($rows= $cstmr->fetch_array())
                                          {
                                              ...
                                              $pop = $rows["pop"];
                                              $area = $rows["area"];
                                            $crtDate = $rows["createdate"];
                                           
                                             echo '
                                             <tr>
                                             <td>'.$lstid.'</td>
                                             <td><a href="profile.php?clid='.$lstid.'">'.$fullname.'</a></td>
                                             <td>'.$package.'</td>
                                             <td>'.$crtDate.'</td>
                                             </tr>
                                             '; 
                     ...
                     <div class="col-md-6">
                        <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 mt-1 py-2">
                                        <p class="card-title ">POP/Transaction Statment</p>
                                        </div>
                                        <div class="col-md-4">
                                            <button style="float: right;">
                                                <a href="#">+</a>
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                           <?php 
                                        if ($pop_tra = $con -> query("SELECT * FROM pop_transaction WHERE pop_id='$popid' LIMIT 5 ")) {
                                          while($rows= $pop_tra->fetch_array())
                                          {
                                              $lstid=$rows["id"];
                                              $amount=$rows["amount"];
                                              $action = $rows["action"];
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="addModal">
     <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
           ...
           <div class="card">
              <div class="card-body">
                    <input class="d-none" type="text" name="id" value="<?php echo $popid; ?>">
                     ...
                     <div class="form-group mb-2">
                        ...
                        <select name="tra_type" class="form-select">
                            <option value="">Select</option>
            ...
            $(document).ready(function(){
                $("#submitBtn").click(function(){
                   ...
                   $.ajax({
                    type:"GET",
                    data:formData,
                    url:"include/pop_transaction.php?add",
                    cache:false,
                    success:function(){
                       $("#addModal").modal('hide');
