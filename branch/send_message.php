                        ...
                        <div class="card shadow-lg ">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm">
                                        <div class="form-group mb-2">
                                            ...
                                            <select  name="cstmr_ac" id="cstmr_ac" class="form-control " style="height:55px;" onchange="currentCstmrAc()">
                                                <option>Select</option>
                                                <?php 

                                                if ($cstmr=$con->query("SELECT * FROM customers WHERE pop=$auth_usr_POP_id ")) {
                                ...
                                <div class="row">
                                    ...
                                    if ($allData=$con->query("SELECT * FROM message_template WHERE pop_id=$auth_usr_POP_id ")) {
