   ...
   <body data-sidebar="dark">
                           ...
                           <div class="row mb-3 mt-1">
                                <div class="col-sm d-none">
                                    <div class="form-group ">
                                       <label>User Id</label>
                                        <input  id="id" class="form-control" type="text" name="id" value="<?php if(isset($_SESSION['uid'])){echo $_SESSION['uid']; } ?>">
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="form-group ">
                                ...
                                <div class="col-sm">
                                    <div class="form-group ">
                                       <label>Refer No:</label>
                                         <input class="form-control" type="text" name="refer_no" placeholder="Type Your Refer No">
                                    </div>
                                </div>
                                <div class="col-sm">
                                    <div class="form-group ">
                                       <label>Description:</label>
                                        <input class="form-control" type="text" name="desc" placeholder="Type Your Description">
                                    </div>
                                </div>
                        ...
                        <?php 
                           ...
                           ?>
                               ...
                               <div class="col-sm">
                                ...
                                <div class="col-sm">
                                    <div class="form-group mb-3">
                                        <button type="button" id="submitBtn" class="btn btn-primary" style="margin-top: 22px;">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                  ...
                  <div class="row">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <table id="purchase_table" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                               <thead>
                                   <tr>
                                      <th>No:</th>
                                      <th>List</th>
                               ...
                               if ($invDetails=$con->query("SELECT *FROM purchase_details")) {
    ...
    <script type="text/javascript">
         $(document).ready(function(){
            ...
            $("#customer-list").load("include/sale.php?list");
        $.ajax({
            type: "GET",
            url: "include/sale.php?list",
            cache: false,
            success: function(list) {
                $("#customer-list").html(list);
            }
        });
             ...
             $("#submitBtn").click(function(e){
               ...
               if (client.length==0) {
                  ...
                  toastr.error("Item name require");
               }else if(quantity.length==0){
                  toastr.error("Quantity require");
               }else if(value.length==0){
                  toastr.error("Value require");
               }else{
                 var formData=$("#transactions_data").serialize();
                alert(formData);
                $.ajax({
                 type:"GET",
                 url:"include/purchase.php?add",
                 data:formData,
                 cache:false,
                 success:function(){
