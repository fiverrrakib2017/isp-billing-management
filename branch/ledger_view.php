                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="d-none d-sm-block ms-2">
                            <h4 class="page-title">Ledger View</h4>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="d-flex justify-content-between flex-wrap">
                                ...
                                <div class="d-flex justify-content-between align-items-end flex-wrap">
                                 ...
                                 data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg" style="margin-bottom: 12px;">&nbsp;&nbsp;New Sub Ledger</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-content col-md-10">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel"><span
                                            class="mdi mdi-lan mdi-18px"></span> &nbsp;New Sub Ledger</h5>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            <input type="hidden" class="form-control"
                                                name="ledgerId" placeholder="Ledger Id"
                                                value="<?php echo $id; ?>">
                                        </div>
                                        <div class="form-group ">
                                            <input type="text" class="form-control" name="name"
                                                placeholder="Item Name" id="name">
                                        </div><br>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input class="form-control"
                                                ...
                                                name="discription" id="description">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-5  p-2">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <h6 class="mb-0">Master Ledger:</h6>
                                                </div>
                                                <div class="col text-secondary">
                                                    <?php echo $ledger; ?>
                                                </div>
...
if ($sbledger=$con->query("SELECT * FROM  legder_sub WHERE ledger_id='$ledger_id'")) {
    while($rows= $sbledger->fetch_assoc()){
     ...
     '; 
                                                     ...
                                                     ?>
                                                     <!-- <a class="btn btn-danger" href="include/ledger_view_delete.php?id='.$id.'"><i class="fas fa-trash"></i></a> -->
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
...
<!-- end main content-->
    ...
    $(document).ready(function() {
        ...
        $("#ledger-list").load("include/sub_ledger.php?list=<?php echo $ledger_id;?>");
        var ledger = "0";
        $.ajax({
            type: "GET",
            url: "include/sub_ledger?list",
            cache: false,
            success: function(ledgerlist) {
                $("#ledger-list").html(ledgerlist);
            }
        });
