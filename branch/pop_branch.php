...
<div class="main-content">
                              ...
                              <div class="card-body">
                                 <div class="row">
                                    ...
                                    <div class="col-md-12 ">
                                            <div class="form-group mb-3">
                                                <label>Note</label>
                                                <textarea  name="note" placeholder="Enter Your Text" class="form-control" rows="4" cols="50"></textarea >
 ...
 <td><?php echo $popId= $rows['id']; ?></td>
        <td><?php echo $popName= $rows['pop']; ?></td>
        <td>
           <?php 
        ...
        <td>
<?php 
echo  $rows['opening_bal'];

 ?>

        </td>
        <td  style="text-align:right">
        <a class="btn btn-success" href="view_pop.php?id=<?php echo $rows['id']; ?>"><i class="mdi mdi-eye"></i></a>
        
        <a class="btn btn-info"  href="pop_edit.php?id=<?php echo $rows['id']; ?>"><i class="fas fa-edit"></i></a>

        <a class="btn btn-danger" onclick=" return confirm('Are You Sure');" href="include/pop_delete.php?id=<?php echo $rows['id']; ?>"><i class="fas fa-trash"></i></a>
        ...
        <script type="text/javascript">
            ...
            function add_pop_branch(){
                $("#addButton").click(function(){
                   ...
                   alert(pop+fullname+username+password+opening_bal);
                });
            }
        </script>
    </body>
