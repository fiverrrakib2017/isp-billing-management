                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="updateArea">
                                        ...
                                        <input id="form" name="area" class="form-control form-control-sm"
                                            type="text" value="<?php echo $area_name; ?>"><br>
                                        <label><b style="color: green;">Billing Date*</b></label>
                                        <input type="text" name="billing_date" class="form-control form-control-sm"
                                            value="<?php echo $billing_date ?? 0; ?>"><br>
                                        <button id="up_area_button" class="btn btn-primary mr-1">Update</button>
                                        <a href="pop_area.php" id="up_delete_button"
                                            class="btn btn-danger mr-1">Cancle</a>
                                    </form>
                                </div>
                            </div>
                        </div>
