...
<div class="main-content">
    ...
    <tbody id="tableBody">
    <?php 
$sql = "SELECT u.id, DATE(cr.datetm) AS recharge_date, SUM(cr.sales_price) AS total_collection, u.fullname AS recharge_by_name  FROM customer_rechrg cr JOIN users u ON cr.rchg_by = u.id WHERE cr.pop_id = '$auth_usr_POP_id' AND cr.status = '0' GROUP BY u.id, DATE(cr.datetm), u.fullname ORDER BY recharge_date DESC";
