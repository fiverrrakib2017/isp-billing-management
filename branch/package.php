                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="d-none d-sm-block ms-2">
                            <h4 class="page-title">Customer Package</h4>
                        </div>
                    </div>
                        ...
                        <div class="d-flex justify-content-between flex-wrap">
                           <div class="d-flex align-items-end flex-wrap">
                              <div class="mr-md-3 mr-xl-5">
                                 <div class="d-flex">
                                    ...
                                    <p class="text-primary mb-0 hover-cursor">Package</p>
                                 </div>
                              </div>
                              <br>
                           </div>
                           <div class="d-flex justify-content-between align-items-end flex-wrap">
                              <button class="btn btn-primary mt-2 mt-xl-0 mdi mdi-account-plus mdi-18px"
                                 data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg" style="margin-bottom: 12px;">&nbsp;&nbsp;New Package</button>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="modal-content col-md-10">
                           <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel"><span
                                 class="mdi mdi-lan mdi-18px"></span> &nbsp;Package</h5>
                           ...
                           <div>
                              ...
                              <input id="package_name" type="text" class="form-control "
                                 placeholder="1-MBPS / 2-MBPS" name="package_name" />
                              </div>
                              </div>
                              </div>
                              <div class="row">
                              ...
                              <input id="form" type="text" class="form-control"
                                 placeholder="172.16.1.2" name="package_strtip" />
                              </div>
                              </div>
                              </div>
                              </form>
