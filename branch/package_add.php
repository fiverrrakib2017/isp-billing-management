                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="d-none d-sm-block ms-2">
                            <h4 class="page-title">Package's</h4>
                        </div>
                    </div>
...
<!-- end main content-->
    ...
    $(document).ready(function(){
        ...
        $("#package-list").load("include/add_package.php?list");

        $.ajax({
            type: "GET",
            url: "include/add_package.php?list",
            cache: false,
   ...
   $("#add_package").click(function(){
    ...
    if (package_list.length==0) {
        ...
        var formData=$("#form-package").serialize();
         ...
         type:"GET",
         data:formData,
         url:"include/add_package.php?add",
         cache:false,
...
function getPackage(){
    ...
    $.ajax({
        type:'POST',
        data:{get_package_list:package_list},
        url:"include/add_package.php",
        success:function(response){
