                            ...
                            <div class="d-flex justify-content-between flex-wrap">
                                ...
                                <div class="d-flex justify-content-between align-items-end flex-wrap">
                                    <button class="btn btn-primary mt-2 mt-xl-0 mdi mdi-account-plus mdi-18px"
                                        ...
                                        style="margin-bottom: 12px;">&nbsp;&nbsp;&nbsp;New Template</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="form-group mb-2">
                                            ...
                                            <input class="form-control" type="text" id="template_name"
                                                placeholder="Type Your Template Name" />
                                        </div>
                                        <div class="form-group mb-2">
                                            <label>Message Template</label>
                                            <textarea class="form-control" type="text" id="template_message" placeholder="Type Your Text Here" style="height: 105px;"></textarea>
                                        </div>
                                        <div class="form-group mb-2 d-none">
                                            <input class="form-control" type="text" id="pop_id"
                                                value="<?php echo $auth_usr_POP_id; ?>" />
                                        </div>
                                        <div class="form-group mb-2 d-none">
                                            <input class="form-control" type="text" id="user_type"
                                                value="<?php echo $auth_usr_type; ?>" />
                                        </div>
                                    </form>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <button id="add_template" type="button" class="btn btn-primary">Add
                                        Template</button>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:right">
                                                        <a href="message_template_edit.php?id=<?php echo $rows['id']; ?>"
                                                            class="btn-sm btn btn-info"><i class="fas fa-edit"></i></a>
