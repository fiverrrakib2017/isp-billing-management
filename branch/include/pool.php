...
if (isset($_GET["update"])) {
  ...
  $endIP=$_GET["end-ip"];
  $con->query("UPDATE pool SET name='$poolname',start_ip='$strtIP',end_ip='$endIP' WHERE id=$poolId");
...
if(isset($_GET['add']))
	{
       ...
       //INSERT INTO `pool` (`id`, `radgrp_id`, `name`, `start_ip`, `end_ip`) VALUES (NULL, '0', 'rakib', '172.16.11.1', '172.16.10.254');
        ...
        $result=$con->query("INSERT INTO pool (radgrp_id,name,start_ip,end_ip)VALUES(0,'$poolname','$pool_start_ip','$pool_end_ip_ip')");
		if ($result==true) {
            echo 1; 
        }else{
            echo 0; 
