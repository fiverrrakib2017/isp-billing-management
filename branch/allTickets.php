                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="d-flex justify-content-between flex-wrap">
                                ...
                                <div class="d-flex justify-content-between align-items-end flex-wrap">
                                    <button class="btn btn-primary mt-2 mt-xl-0 mdi mdi-account-plus mdi-18px" data-bs-toggle="modal" data-bs-target="#addTicketModal" style="margin-bottom: 12px;">&nbsp;&nbsp;Add Ticket</button>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="tickets_profile.php?id=<?php echo $rows['id']; ?>"><?php echo $rows["ticket_type"]; ?></a></td>
                                                        <td><?php echo $rows["asignto"]; ?></td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-info" href="tickets_edit.php?id=<?php echo $rows['id']; ?>"><i class="fas fa-edit"></i></a>
                                                            <a class="btn btn-success" href="tickets_profile.php?id=<?php echo $rows['id']; ?>"><i class="fas fa-eye"></i>
                                                            </a>

                                                            <a href="ticket_delete.php?id=<?php echo $rows['id']; ?>" class="btn btn-danger deleteBtn" onclick=" return confirm('Are You Sure');"><i class="fas fa-trash"></i>
                                                            </a>
