                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="d-none d-sm-block ms-2">
                            <h4 class="page-title">Bill Collector</h4>
                        </div>
                    </div>
                           ...
                           <div class="d-flex align-items-end flex-wrap">
                              <div class="mr-md-3 mr-xl-5">
                                 <div class="d-flex">
                                    ...
                                    <p class="text-primary mb-0 hover-cursor">Bill Collector</p>
                                 </div>
                              </div>
                              <br>
                           </div>
                     ...
                     <div class="col-md-12 stretch-card">
                        <div class="card">
                            <div class="card-header">
                                <button type="submit" name="bill_button" class="btn-sm btn btn-primary">Bill Collection</button>
                            </div>
                           <div class="card-body">
        ...
        $(document).ready(function(){
            ...
            $("button[name='bill_button']").click(function(){
                ...
                $('#datatable input[type="checkbox"]:checked').each(function() {
                    ...
                    console.log(row); 
                    totalAmount = row.find('td:eq(2)').text().trim(); // Adjust index if needed
                    //collectionDate = row.find('td:eq(4)').text().trim(); // Adjust index if needed
