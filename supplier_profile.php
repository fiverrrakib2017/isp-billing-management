            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="d-none d-sm-block ms-2">
                        <h4 class="page-title">Supplier's Profile</h4>
                    </div>
                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex py-2" style="float:right;">
                                        ...
                                        <!-- <abbr title="Temp. Recharge">
                                            <button type="button" id="temprechargeBtn" class="btn-sm btn btn-secondary">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="col-12 bg-white p-0 px-2 pb-3 mb-3">
                                                    ...
                                                    <div class="d-flex justify-content-between border-bottom py-2 px-3">
                                                        <p><i class="fas fa-id-card"> </i> Address: <br>
                                                            <?php echo $address; ?>
                                                        </p>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="row no-gutters align-items-center">
                                                            <div class="col mr-2">
                                                                ...
                                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                                    ...
                                                                    if ($totalPurchase = $con->query("SELECT SUM(grand_total) AS Amount FROM purchase WHERE client_id='$clid' ")) {
                                                        ...
                                                        <div class="row no-gutters align-items-center">
                                                            <div class="col mr-2">
                                                                ...
                                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                                    ...
                                                                    <?php
                                                                    if ($paidamt = $con->query("SELECT SUM(total_paid) AS Amount FROM purchase WHERE client_id='$clid' ")) {
                                                                        while ($r_paid_rows = $paidamt->fetch_array()) {
                                                                            $totalpaid = $r_paid_rows["Amount"];
                                                                        }
                                                                        //echo $totalpaid;
                                                                    }
                                                                    if ($receivedAmt = $con->query("SELECT SUM(due_amount) AS Amount FROM purchase_dues WHERE client_id='$clid' ")) {
                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <table id="transaction_datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                                                    ...
                                                                                    <tbody id="ticket-list">
                                                                                        <?php
                                                                                        $totalCount=1;
                                                                                        $sql = "SELECT * FROM purchase_dues WHERE client_id=$lstid";
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="table-responsive">
                                                                                <table id="invoice_datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                                                    ...
                                                                                    <tbody id="ticket-list">
                                                                                        <?php
                                                                                        $sql = "SELECT * FROM purchase WHERE status='1' AND client_id=$lstid";
                                                                                        $result = mysqli_query($con, $sql);
