...
<body data-sidebar="dark">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="d-flex justify-content-between flex-wrap">
                                ...
                                <div class="d-flex justify-content-between align-items-end flex-wrap">
                                    <button type="button" class="btn btn-primary mt-2 mt-xl-0 mdi mdi-account-plus mdi-18px" data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg" style="margin-bottom: 12px;">&nbsp;&nbsp;New
                                        Client</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal fade bs-example-modal-lg" id="client-add-popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align:right">
                                                            <a class="btn btn-info" href="client_edit.php?clid=<?php echo $rows['id']; ?>"><i class="fas fa-edit"></i></a>
                                                            <a class="btn btn-success" href="client_profile.php?clid=<?php echo $rows['id']; ?>"><i class="fas fa-eye"></i>
                                                            </a>
                                                            <a onclick=" return confirm('Are You Sure');" class="btn btn-danger" href="client_delete.php?clid=<?php echo $rows['id']; ?>"><i class="fas fa-trash"></i>
                                                            </a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#client-list").load("include/client_data.php?list");
            $.ajax({
                type: "GET",
                url: "include/client_data.php?list",
                cache: false,
