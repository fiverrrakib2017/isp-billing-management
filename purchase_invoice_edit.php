...
if (isset($_GET["id"])) {
    $id = $_GET['id'];
    if ($purchase = $con->query("SELECT * FROM purchase WHERE id=".$_GET['id'] ."")) {
        while ($rows = $purchase->fetch_array()) {
            $id = $rows['id'];
            $usr_id = $rows['usr_id'];
...
<body data-sidebar="dark">
    ...
    <!-- END layout-wrapper -->
    <!-- Right Sidebar -->
    <div class="modal fade bs-example-modal-lg" id="supplierModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content col-md-10">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><span class="mdi mdi-account-check mdi-18px"></span> &nbsp;New Supplier</h5>
                ...
                <div class="card-body">
                    <form action="" id="paymnt_process">
                        <div class="form-group mb-2">
                            ...
                            <input type="number" name="subTotal" placeholder="Enter Sub total Amount" class="form-control payment_sub_total">
                        </div>
                        <div class="form-group mb-2">
                            <label for="">Discount</label>
                            <input type="number" name="Discounts" value="00" placeholder="Enter Amount" class="form-control payment_discount">
                        </div>
                        <div class="form-group mb-2">
                            <label for="">Grand Total</label>
                            <input type="number" name="GrandTotal" placeholder="Enter  Amount" class="form-control payment_grand_total">
                        </div>
                        <div class="form-group mb-2">
                            <label for="">Total Paid</label>
                            <input type="number" name="totalPaid" placeholder="Enter  Amount" class="form-control payment_totalPaid">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
