...
if ($pop_list = $con -> query("SELECT * FROM add_pop WHERE id='$areaid'")) {
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="d-flex justify-content-between flex-wrap">
                                ...
                                <div class="d-flex justify-content-between align-items-end flex-wrap">
                                    ...
                                    <abbr title="Recharge">
                                        <button type="button" data-target="#rechargeModal" data-toggle="modal"
                                        class="btn btn-light bg-white btn-icon mr-3 d-none d-md-block ">
                                        <i class="mdi mdi mdi-battery-charging-90 text-muted"></i>
                                        </button>
                                    </abbr>
                                   <abbr title="Cutomers"><button type="button"
                                        class="btn btn-light bg-white btn-icon mr-3 d-none d-md-block ">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                          <?php 
                            if ($recharge_customer = $con -> query("SELECT SUM(amount) AS Amount FROM customer_rechrg WHERE customer_name='$username' AND type='1'")) {
                              while($r_cus_rows= $recharge_customer->fetch_array())
                              {
                                  $totalpaid =$r_cus_rows["Amount"];
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800">
                          <?php 
                            if ($dueamt = $con -> query("SELECT SUM(amount) AS Amount FROM customer_rechrg WHERE customer_name='$username' AND type='0'")) {
                              while($r_due_rows= $dueamt->fetch_array())
                              {
                                  $totaldue =$r_due_rows["Amount"];
...
<tbody id="ticket-list">
    ...
    if ($ticket=$con->query("SELECT * FROM ticket WHERE pop='$areaid' LIMIT 5")) {
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                           <?php 
                                        if ($cstmr = $con -> query("SELECT * FROM customers WHERE area='$areaid'")) {
                                          while($rows= $cstmr->fetch_array())
                                          {
                                            ...
                                            // POP Name 
                                                        ...
                                                        if ($get=$con->query("SELECT * FROM `add_pop` WHERE `id`=$pop")) {
                                                            while ($rows3=$get->fetch_array()) {
                                                                 $popName = $rows3['pop'];
                                                            }
                                                        }
