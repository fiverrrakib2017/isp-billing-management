...
if (isset($_POST['update'])) {
   ...
   $result=$con->query("UPDATE marketing_client set company_name='$company_name',contact_name='$contact_name', mobile_number='$mobile_number', mobile_number2='$mobile_number2', area='$area', address='$address', details='$details' WHERE id='$id' ");
   if ($result==true) {
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="marketing_client.php">Marketing Client</a></li>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="card mt-3">
                                    <div class="card-title text-center mt-3">
                                        <h5>Marketing Client Details</h5>
                                    </div>
                                    <hr>
                                    <div class="card-body">
                            ...
                            <div class="col-md-8">
                                <div class="card mb-3">
                                    <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
                                        <input class="d-none" type="text" name="id" value="<?php echo $userId; ?>">
                                        <div class="card-body">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 ">
                                                    <input type="text" name="" class="form-control" value="<?php echo $contact_name; ?>">
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="" class="form-control" value="<?php echo $mobile_number; ?>">
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                   <input type="text" name="" class="form-control" value="<?php echo $mobile_number2; ?>">
                                                </div>
                                            </div>
                                            <hr>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="" class="form-control" value="<?php echo $area; ?>">
                                                </div>
                                            </div>
                                            <hr>
