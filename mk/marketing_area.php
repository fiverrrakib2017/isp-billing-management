...
<div class="main-content">
                        ...
                        <div class="d-flex justify-content-between flex-wrap">
                           ...
                           <div class="d-flex justify-content-between align-items-end flex-wrap">
                              ...
                              <button class="btn btn-primary mt-2 mt-xl-0 mdi mdi-account-plus mdi-18px"
                                 data-bs-toggle="modal" data-bs-target=".bs-example-modal-lg">New
                              Area</button>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="modal-dialog" role="document">
                        <div class="modal-content">
                           <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel">Add Marketing Client Area</h5>
                           ...
                           <div class="card">
                              <div class="card-body">
                                 <div class="row">
                                    <div class="col-md-12">
                                       <form id="area_form">
                                          <input class="form-control" type="text" name="area" placeholder="Type Your Area"/>
                                       </form>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="modal-footer">
                              ...
                              <button type="submit" id="area_button" class="btn btn-primary"data-bs-dismiss="modal">Add New</button>
                           </div>
                        </div>
                     </div>
                  </div>
                              ...
                              <div class="table-responsive">
                                 <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                    ...
                                    <tbody>
                                        ...
                                        if ($area_list = $con -> query("SELECT * FROM marketing_area")) {
    while($rows= $area_list->fetch_array())
    {
      ...
      <tr>
        ...
        <td>'.$area_name.'</td>
        <td class="text-right">
        <a class="btn btn-info" href="area_edit.php?id='.$lstid.'"><i class="mdi mdi-border-color"></i></a>
        <a class="btn btn-success" href="view_area.php?id='.$lstid.'"><i class="mdi mdi-eye"></i>
        </a>
...
<script type="text/javascript">
   ...
   $("#area_button").click(function(){
      var formData=$("#area_form").serialize();
      alert(formData);
         $.ajax({
         type:"GET",
         data:formData,
