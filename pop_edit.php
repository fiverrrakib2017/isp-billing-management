                ...
                <div class="navbar-header">
                    <div class="d-flex">
                        ...
                        <div class="d-none d-sm-block ms-2">
                            <h4 class="page-title">POP/Branch Update</h4>
                        </div>
                    </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row mt-5 py-3 mr-3 ml-3">
                    ...
                    <div class="col-md-4 m-auto" id="formArea">
                        ...
                        <h4 class="text-center">Update POP/BRANCH</h4><br>
                        <form id="updatePop">
                            <label><b style="color: green;">POP Name *</b></label>
                            <input class="d-none" type="text" value="<?php echo $id; ?>" name="id">
                            <input id="form" name="pop" class="form-control " type="text" value="<?php echo $popName; ?>"><br>
                            <button id="up_pop_button" class="btn btn-success mr-1">Update</button>
                            <a href="pop_branch.php" class="btn btn-danger mr-1">Cancle</a>
                        </form>
                    </div>
