...
function acctual_work($startdate, $enddate) {
    ...
    return 'just now'; // Default return if the difference is less than a second
}
                                        ...
                                        while ($stmr = $customer->fetch_array()) {
                                            ...
                                            while ($all_area = $get_all_area->fetch_array()) {
                                               echo  $all_area['name'];
                                                        ...
                                                        <td>
                                                            <a class="btn-sm btn btn-info" href="tickets_edit.php?id=<?php echo $rows['id']; ?>"><i class="fas fa-edit"></i></a>
